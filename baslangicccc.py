...
#open and read file
f = open("demo.txt", "r") #okuma modu
print(f.read()) #dosyayı baştan sona okur
f.close() #dosyayı kapatır

f = open("demo.txt", "r")
print(f.read(5)) #dosyayı 5 karakter okur  
f.close()


f = open("demo.txt", "r")
print(f.readline()) #dosyayı 1 satır okur
f.close()

f = open("demo.txt", "r")
for x in f: #dosyayı satır satır okur
    print(x)
f.close()

f = open("demo.txt", "a") #ekleme modu
f.write("frrrrrrrrenkkrkrkr sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.\n")
f.close()

f = open("demo.txt", "a")
f.write("this is my test") #her seferinde en sona ekler
f.close()
...
import os
if os.path.exists("demo2.txt"): #dosya var mı diye kontrol eder
    os.remove("demo2.txt") #dosyayı siler
